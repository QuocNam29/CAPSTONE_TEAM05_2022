...
namespace CAP_TEAM05_2022.Controllers
{
    public class RevenuesController : Controller
    {
        ...
        public ActionResult SumRevenue()
        {
            return View();
        }
        public ActionResult _SumRevenueList(DateTime? date_Start, DateTime? date_End)
        {
            if (date_Start == null)
            {
        ...
        public ActionResult _TemplatePrintSumRevenues(DateTime? date_Start, DateTime? date_End)
        {
            ViewBag.DateStart = date_Start;
            ViewBag.DateEnd = date_End;
            if (date_Start == null)
